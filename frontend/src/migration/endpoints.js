...
export const ENDPOINTS = Object.freeze({
  ...
  [MigrationObjectType.HELP_CENTER_CATEGORIES]: {
    ...
    wrapperKey: "category",
    listPath: "/api/v2/help_center/categories.json",
    createPath: "/api/v2/help_center/categories.json",
    updatePath: (id) => `/api/v2/help_center/categories/${encodeURIComponent(id)}.json`,
    idField: "id",
  },
  [MigrationObjectType.HELP_CENTER_SECTIONS]: {
    ...
    wrapperKey: "section",
    listPath: "/api/v2/help_center/sections.json",
    createPath: (categoryId) => `/api/v2/help_center/categories/${encodeURIComponent(categoryId)}/sections.json`,
    updatePath: (id) => `/api/v2/help_center/sections/${encodeURIComponent(id)}.json`,
    idField: "id",
  },
  [MigrationObjectType.HELP_CENTER_ARTICLES]: {
    ...
    wrapperKey: "article",
    listPath: "/api/v2/help_center/articles.json",
    createPath: (sectionId) => `/api/v2/help_center/sections/${encodeURIComponent(sectionId)}/articles.json`,
    updatePath: (id) => `/api/v2/help_center/articles/${encodeURIComponent(id)}.json`,
    idField: "id",
  },
